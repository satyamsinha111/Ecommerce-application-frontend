...
import {getAllCategories, CreateProduct} from "./adminhelper/dashboardmodules";
...
class AddProduct extends React.Component {
    ...
    onSubmit(event) {
        ...
        CreateProduct(user._id, token, this.state.formData).then(data => {
            if (data.error) {
                    ...
                    <div className="row">
                        <div className="col-6">
                            <div className="form-group mb-0">
                                ...
                                <label className="btn  btn-success btn-block btn-sm"
                                    style={
                                        {color: "white"}
                                }>
                                    <input type="file" name="photo" accept="image" placeholder="choose a file" required
                                        onChange={
                                            this.handleChange
                                        }/>
                                </label>
